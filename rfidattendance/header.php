...
<div class="header">
	<div class="logo">
		<img src="1.png" alt="1" width="80" height="80">
		<a href="index.php">VIT Attendance Management System</a>
	</div>
</div>
<?php  
  if (isset($_GET['error'])) {
...
<div class="topnav" id="myTopnav">
    ...
    <a href="UsersLog.php">Logs</a>
    <a href="devices.php">Departments</a>
    <?php  
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLongTitle">Update Your Account Details:</h3>
